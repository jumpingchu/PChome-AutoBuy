...
4. 登入帳戶（若有使用 CHROME_PATH 記住登入資訊，要記得註解掉）
   
5. 點選一次付清 (或是使用 LINE Pay)
   
6. 提示訊息點擊「確定」（此為特殊狀況，某些商品不會出現）
   
7. 填入身分證字號、生日、信用卡安全碼
   
8. 勾選同意（若帳號有設定記住付款資訊，要記得拿掉）
...
* 可能的解決方法可參考 [#8](https://github.com/jumpingchu/PChome-AutoBuy/issues/8)
